...
<body>
    <?php
        $tydrukud = array('mari'; 'kati', 'julia', 'minni', 'imretard', 'kevinm', 'ulledoos', 'karineegreid');
        sort($tydrukud);
        $counter = 0;
        echo "<ul>";
...
"1N6AA0EDXFN868772", "WBADW3C59DJ422810");
    ...
    if (count($cars) == count($vins)) {
        echo "Autode ja Vinnide arvud on võrdsed<br>";

    } else {
        echo "Autode ja Vinnide arvud ei ole võrdsed<br>";
    }
    // $toyota = 0;
    // $audi = 0;
    echo "Toyotad kokku: ".array_count_values($cars)['Toyota'];
?>
</body>
</html>